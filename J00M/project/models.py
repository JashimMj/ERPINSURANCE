...
class MarineCovernoteM(models.Model):
    ...
    userc = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True)
    Coins_Leader = models.CharField(max_length=20, null=True, blank=True)
    Coins_None_Leader = models.CharField(max_length=20, null=True, blank=True)
    Coins_Leader_Persent = models.CharField(max_length=20, null=True, blank=True)
    Coins_Leader_Doc = models.CharField(max_length=20, null=True, blank=True)
...
class MarineAddendumM(models.Model):
    ...
    Coins_Leader_Doc = models.CharField(max_length=20, null=True, blank=True)
    Coins_Leader_Name = models.CharField(max_length=20, null=True, blank=True)
    Addendum_number=models.CharField(max_length=255,null=True,blank=True)
    Addendum_no=models.CharField(max_length=50,null=True,blank=True)
